...
link_bench_path=/back_up_data/linkbench_10_4k
...
#cd $bld_path && valgrind --leak-check=yes ./bin/mysqld --defaults-file=/home/vldb/mysql-57-nvdimm-ipl/my_4k_10G.cnf &
# cd $bld_path && ./bin/mysqld --defaults-file=/home/vldb/mysql-57-nvdimm-ipl/my_4k_10G.cnf &
cd $bld_path && gdb --args ./bin/mysqld --defaults-file=/home/vldb/mysql-57-nvdimm-ipl/my_4k_10G.cnf --disable-log-bin #&>/dev/null &disown 
# check_disk_space
echo $passwd | sudo -S sysctl vm.drop_caches=3
