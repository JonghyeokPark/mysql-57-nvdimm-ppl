...
static monitor_info_t	innodb_counter_info[] =
{
	...
	{"nvdimm_ppl_redo_out_null", "nvdimm_ppl",
	 "PPL-MV path returned old_vers = NULL (no old version)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_REDO_OUT_NULL},

	/* ===== LLT 7-path version build breakdown =====
	   Time = entry → visible old_vers return (full build time).
	   SNAP = OPPL 4KB snapshot base; OLD = .ibd fil_io base; LATEST = BP latest.
	   MATCH = base visible as-is; REDO = forward apply chunks; UNDO = backward walk. */
	{"nvdimm_ppl_llt_snap_match_calls", "nvdimm_ppl",
	 "LLT SNAP_MATCH: OPPL snap visible, no chunks needed",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_MATCH_CALLS},
	{"nvdimm_ppl_llt_snap_match_us_sum", "nvdimm_ppl",
	 "LLT SNAP_MATCH: build time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_MATCH_US_SUM},
	{"nvdimm_ppl_llt_snap_redo_calls", "nvdimm_ppl",
	 "LLT SNAP_REDO: OPPL snap + forward apply chunks",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_REDO_CALLS},
	{"nvdimm_ppl_llt_snap_redo_us_sum", "nvdimm_ppl",
	 "LLT SNAP_REDO: build time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_REDO_US_SUM},
	{"nvdimm_ppl_llt_snap_redo_len_sum", "nvdimm_ppl",
	 "LLT SNAP_REDO: chunks applied sum (chain length)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_REDO_LEN_SUM},
	{"nvdimm_ppl_llt_snap_undo_calls", "nvdimm_ppl",
	 "LLT SNAP_UNDO: OPPL snap too new → backward undo walk",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_UNDO_CALLS},
	{"nvdimm_ppl_llt_snap_undo_us_sum", "nvdimm_ppl",
	 "LLT SNAP_UNDO: build time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_UNDO_US_SUM},
	{"nvdimm_ppl_llt_snap_undo_len_sum", "nvdimm_ppl",
	 "LLT SNAP_UNDO: undo records walked sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_SNAP_UNDO_LEN_SUM},
	{"nvdimm_ppl_llt_old_match_calls", "nvdimm_ppl",
	 "LLT OLD_MATCH: .ibd fil_io page already visible (no chunks)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_MATCH_CALLS},
	{"nvdimm_ppl_llt_old_match_us_sum", "nvdimm_ppl",
	 "LLT OLD_MATCH: build time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_MATCH_US_SUM},
	{"nvdimm_ppl_llt_old_redo_calls", "nvdimm_ppl",
	 "LLT OLD_REDO: .ibd fil_io + NVDIMM PPL chain forward apply",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_REDO_CALLS},
	{"nvdimm_ppl_llt_old_redo_us_sum", "nvdimm_ppl",
	 "LLT OLD_REDO: build time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_REDO_US_SUM},
	{"nvdimm_ppl_llt_old_redo_len_sum", "nvdimm_ppl",
	 "LLT OLD_REDO: PPL chunks applied sum (chain length)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_REDO_LEN_SUM},
	{"nvdimm_ppl_llt_old_undo_calls", "nvdimm_ppl",
	 "LLT OLD_UNDO: .ibd disk too new → undo walk from disk frame's rec",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_UNDO_CALLS},
	{"nvdimm_ppl_llt_old_undo_us_sum", "nvdimm_ppl",
	 "LLT OLD_UNDO: build time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_UNDO_US_SUM},
	{"nvdimm_ppl_llt_old_undo_len_sum", "nvdimm_ppl",
	 "LLT OLD_UNDO: undo records walked sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_OLD_UNDO_LEN_SUM},
	{"nvdimm_ppl_llt_latest_undo_stock_calls", "nvdimm_ppl",
	 "LLT LATEST_UNDO stock: nvdimm DB_FAIL → caller undo from BP latest",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_STOCK_CALLS},
	{"nvdimm_ppl_llt_latest_undo_stock_us_sum", "nvdimm_ppl",
	 "LLT LATEST_UNDO stock: caller-side undo walk time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_STOCK_US_SUM},
	{"nvdimm_ppl_llt_latest_undo_stock_len_sum", "nvdimm_ppl",
	 "LLT LATEST_UNDO stock: undo records walked sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_STOCK_LEN_SUM},
	{"nvdimm_ppl_llt_latest_undo_warehouse_calls", "nvdimm_ppl",
	 "LLT LATEST_UNDO warehouse: undo from BP latest (always, no OPPL)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_WAREHOUSE_CALLS},
	{"nvdimm_ppl_llt_latest_undo_warehouse_us_sum", "nvdimm_ppl",
	 "LLT LATEST_UNDO warehouse: undo walk time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_WAREHOUSE_US_SUM},
	{"nvdimm_ppl_llt_latest_undo_warehouse_len_sum", "nvdimm_ppl",
	 "LLT LATEST_UNDO warehouse: undo records walked sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_WAREHOUSE_LEN_SUM},
	{"nvdimm_ppl_llt_latest_undo_district_calls", "nvdimm_ppl",
	 "LLT LATEST_UNDO district: undo from BP latest",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_DISTRICT_CALLS},
	{"nvdimm_ppl_llt_latest_undo_district_us_sum", "nvdimm_ppl",
	 "LLT LATEST_UNDO district: undo walk time sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_DISTRICT_US_SUM},
	{"nvdimm_ppl_llt_latest_undo_district_len_sum", "nvdimm_ppl",
	 "LLT LATEST_UNDO district: undo records walked sum",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_LATEST_UNDO_DISTRICT_LEN_SUM},
	{"nvdimm_ppl_llt_redo_build_calls", "nvdimm_ppl",
	 "LLT: total nvdimm_build_prev_vers_with_redo invocations (sanity)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
	 MONITOR_NVDIMM_PPL_LLT_REDO_BUILD_CALLS},
	{"nvdimm_ppl_llt_redo_build_us_sum", "nvdimm_ppl",
	 "LLT: total nvdimm_build_prev_vers_with_redo time sum (sanity)",
	 MONITOR_DEFAULT_ON, MONITOR_DEFAULT_START,
