...
extern mysql_pfs_key_t nvdimm_static_region_mutex_key;
extern mysql_pfs_key_t nvdimm_dynamic_region_mutex_key;
extern mysql_pfs_key_t nvdimm_second_dynamic_region_mutex_key;
