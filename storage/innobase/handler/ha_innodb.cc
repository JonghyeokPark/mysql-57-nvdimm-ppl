...
#ifdef UNIV_NVDIMM_PPL
static MYSQL_SYSVAR_BOOL(use_nvdimm_ppl, srv_use_nvdimm_ppl,
  PLUGIN_VAR_NOCMDARG | PLUGIN_VAR_READONLY,
...
static MYSQL_SYSVAR_BOOL(use_nvdimm_ppl_recovery, srv_use_nvdimm_ppl_recovery,
  PLUGIN_VAR_NOCMDARG | PLUGIN_VAR_READONLY,
